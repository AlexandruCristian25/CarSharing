...
public class ShareCarLogin extends AppCompatActivity {

    private EditText username;
    private EditText password;
    private Button login, registration;
    private ActivityResultLauncher<Intent> addUserLaucher;
    private ActivityResultLauncher<Intent> ShareCarLauncher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShareCarLauncher = registerShareCarlauncher();
    ...
    private ActivityResultLauncher<Intent> registerShareCarlauncher() {

        ActivityResultCallback<ActivityResult> callback = createShareCarCallback();
        return registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),callback);
    }

    private ActivityResultCallback<ActivityResult> createShareCarCallback() {
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userExists()){
                    ...
                    Intent intent = new Intent(getApplicationContext(),CarSharing.class);
                    ShareCarLauncher.launch((intent));
